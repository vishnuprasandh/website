...
const Home = () => {
  return (
    <>
      <PageTemplate title="Home - Go Prime Technologies">
        {/* Banner Section */}
        <section
        ...
        >
          <div className="w-10/12 md:w-8/12 text-center">
            <PageSentence
              ...
              description="It is our commitment not to keep clients waiting. Our goal is to deliver the work as soon as possible. The quality of our work is never compromised."
