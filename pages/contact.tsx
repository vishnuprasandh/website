...
const Contact = () => {
  return (
    <>
      <PageTemplate title='Contact - Go Prime Technologies'>
        <section className="grid grid-cols-1 place-items-center gap-10 lg:gap-5 lg:grid-cols-2">
          <aside className="w-full sm:w-10/12 md:w-8/12 grid grid-cols-1 gap-12 sm:place-items-center lg:w-full lg:place-items-start" data-aos="fade-up-right">
            ...
            <div className="space-y-6">
              ...
              <IconListItem
                label="Email"
                value="info@goprimetechnologies.com"
                icon={<FiMail />}
              />
              <IconListItem
                label="Address"
                value="No 9/38, 1st Floor, 1st cross, Deva Nagar, Reddiarpalayam, Puducherry - 605010"
                icon={<FiMapPin />}
              />
            </div>
          </aside>
