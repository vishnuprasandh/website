...
const About = () => {
  return (
    <PageTemplate title="About - Go Prime Technologies">
      ...
      <section className="grid place-items-center gap-16">
        ...
        <div className="w-full grid gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          <div data-aos="fade-up">
            <TeamCard
              imageSrc="/images/manoharceo5.jpg"
              job="Founder & CEO"
              name="Manohar K"
            />
          </div>
          {/* <div data-aos="fade-up">
            <TeamCard
              imageSrc="/images/avinash002.jpg"
              job="CTO & Senior Consultant"
              name="Avinash M"
            />
          </div>
          */}
          ...
          <div data-aos="fade-up">
            <TeamCard
              ...
              job="Software Developer"
              name="Vishnu Prashandh V"
            />
          </div> 
          <div data-aos="fade-up">
            <TeamCard
              imageSrc="/images/vishwa.jpg"
              job="Software Developer"
              name="Vishwa S"
            />
          </div> 
